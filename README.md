...
A continuación se muestra la imagen del esquema empleado para la creación del sistema de gestión de la biblioteca:



![image alt](https://github.com/daaaaniel242/biblioteca/DiagramaClases/blob/main/fotodiagramabiblioteca.png?raw=true)
